...
# Created: 05/16/2024
# CRUD using clever-cloud - Final Examination v1.2
...
def Save():
    ...
    if not validate_input(entry_LastName, "Last Name", max_length=50):
        return
    if not validate_input(entry_Age, "Age", is_integer=True, integer_range=(0, 999)):
        return
...
def Delete():
    ...
    elif validate_input(entry_Delete, "Student ID", is_integer=True, integer_range=(0, 999)):
        print("Test1 pass")
        return
...
root = Tk()
root.title("Student Database v1.2")
